...
class midasDepthEstimator():
	...
	def initializeModel(self):
		modelPath = 'models/midasv2_float32.tflite'
	...
	def prepareInputForInference(self, image):
		...
		print("Image input: {}".format(img_input))     
